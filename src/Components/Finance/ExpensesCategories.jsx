...
const ExpensesCategories = () => {
  ...
  const validateForm = () => {
    if (!FinanceCategory.name) {
      toast.error("Expenses Category name is required");
      return false;
    }
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (editing) {
        await axios.put(
          `http://localhost:8080/api/expensesCategories/${editId}`,
          newFinanceCategory
        );
      ...
      toast.error("Error saving Expenses Category");
    }
  };
  ...
  const fetchFinanceCategory = async () => {
    try {
      ...
      toast.error("Failed to load Expenses Category");
    }
  };

  const deleteFinanceCategory = async () => {
    if (!deleteId) {
      toast.error("Invalid Expenses Category ID!");
      return;
    }

    try {
      await axios.delete(
        `http://localhost:8080/api/expensesCategories/${deleteId}`
      );
      ...
      toast.error("Error deleting Expenses Category!");
    }
  };
  ...
  const downloadCSV = () => {
    ...
    const data = [
      {
        "Expenses Category ID": "Expenses Category ID",
        "Expenses Category Name": "Expenses Category Name",
        "Date & Time": "Date & Time",
      },
      ...dataToExport.map((type) => ({
        "Expenses Category ID": type.FinanceCategoryId,
        "Expenses Category Name": type.name,
    ...
    <div>
      ...
      <div className="doctor-nav-buttons">
        <div className="nav_headings">
          ...
          <Link to="/expenses-categories" className="doctor-nav-btn active">
      ...
      />
      {/* Add/Edit Expenses Category Modal */}
      <div
          ...
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">
                {editing ? "Edit Expenses Category" : "New Expenses Category"}
              </h5>
              <button
                type="button"
                className="close"
            ...
            <div className="modal-body">
              <div className="form-group">
                <label>
                  Expenses Category: <span className="text-danger">*</span>
                </label>
                <input
                  type="text"
                  name="name"
      ...
      >
        ...
        >
          <div className="modal-content text-center">
            ...
            <h2>Delete</h2>
            <p>Are you sure want to delete this Expenses Category?</p>
