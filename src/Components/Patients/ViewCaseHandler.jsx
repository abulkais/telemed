              ...
              <div className=" col-md-6">
                ...
                <p className="fs-5 text-gray-800 showSpan">
                  {caseHandler.dateOfBirth
                    ? formatDate(caseHandler.dateOfBirth)
                    : "N/A"}
                </p>
              </div>
              <div className=" col-md-6">
          ...
          <div className="card p-4 border-0">
            <div className="row">
              ...
              <div className=" col-md-6">
                ...
                <p className="fs-5 text-gray-800 showSpan">
                  {getTimeAgo(caseHandler.created_at || "N/A")}
                </p>
              </div>
              <div className=" col-md-6">
                <label className="fs-5 text-gray-600">Updated At:</label>
                <p className="fs-5 text-gray-800 showSpan">
                  {getTimeAgo(caseHandler.updated_at || "N/A")}
                </p>
              </div>
            </div>
          </div>
